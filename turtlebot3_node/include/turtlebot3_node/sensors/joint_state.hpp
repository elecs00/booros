...
private:
  ...
  std::string wheel_rear_left_joint_;
  std::string wheel_rear_right_joint_;
  std::string wheel_front_left_joint_;
  std::string wheel_front_right_joint_;

  std::array<int32_t, MOTOR_NUM> last_position_;
  std::array<int32_t, MOTOR_NUM> last_diff_position_;
};
}  // namespace sensors
}  // namespace turtlebot3
}  // namespace robotis
